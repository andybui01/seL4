...
lai_pci_route(lai_acpi_resource_t *, uint16_t, uint8_t, uint8_t, uint8_t);
lai_api_error_t lai_pci_route_pin(lai_acpi_resource_t *, uint16_t, uint8_t, uint8_t, uint8_t, uint8_t);
