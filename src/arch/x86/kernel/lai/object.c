...
#include <lai/internal/exec_impl.h>
#include <lai/internal/libc.h>

lai_api_error_t lai_create_string(lai_variable_t *object, word_t length) {
...
lai_api_error_t lai_create_buffer(lai_variable_t *object, word_t size) {
...
lai_api_error_t lai_create_pkg(lai_variable_t *object, word_t n) {
...
lai_api_error_t lai_obj_resize_string(lai_variable_t *object, word_t length) {
...
lai_api_error_t lai_obj_resize_buffer(lai_variable_t *object, word_t size) {
...
lai_api_error_t lai_obj_resize_pkg(lai_variable_t *object, word_t n) {
...
lai_api_error_t lai_obj_get_pkg(lai_variable_t *object, word_t i, lai_variable_t *out) {
    if (object->type != LAI_PACKAGE)
        return LAI_ERROR_TYPE_MISMATCH;
...
lai_api_error_t lai_obj_to_buffer(lai_variable_t *out, lai_variable_t *object) {
    switch (object->type) {
        ...
        case LAI_TYPE_STRING: {
            word_t len = lai_exec_string_length(object);
            if (len == 0) {
...
lai_api_error_t lai_mutate_buffer(lai_variable_t *target, lai_variable_t *object) {
    ...
    switch (object->type) {
        ...
        case LAI_BUFFER: {
            word_t copy_size = lai_exec_buffer_size(object);
            word_t buffer_size = lai_exec_buffer_size(target);
        ...
        case LAI_STRING: {
            word_t copy_size = lai_strlen(lai_exec_string_access(object)) + 1;
            word_t buffer_size = lai_exec_buffer_size(target);
            if (copy_size > buffer_size)
                copy_size = buffer_size;
            memset(lai_exec_buffer_access(target), 0, buffer_size);
...
lai_api_error_t lai_obj_to_string(lai_variable_t *out, lai_variable_t *object, word_t size) {
    switch (object->type) {
        case LAI_TYPE_BUFFER: {
            word_t buffer_length = 0;
...
lai_api_error_t lai_obj_to_decimal_string(lai_variable_t *out, lai_variable_t *object) {
    switch (object->type) {
        ...
        case LAI_BUFFER: {
            word_t buffer_len = lai_exec_buffer_size(object);
            uint8_t *buffer = lai_exec_buffer_access(object);
            lai_create_string(
                out,
...
lai_api_error_t lai_mutate_string(lai_variable_t *target, lai_variable_t *object) {
    ...
    switch (object->type) {
        // No conversion necessary.
        case LAI_TYPE_STRING: {
            word_t length = lai_strlen(lai_exec_string_access(object));
        ...
        case LAI_TYPE_BUFFER: {
            word_t length = lai_exec_buffer_size(object);
...
#error Required macro __BYTE_ORDER__ not defined
        ...
        case LAI_STRING: {
            word_t string_len = lai_exec_string_length(object);
...
static void lai_clone_buffer(lai_variable_t *dest, lai_variable_t *source) {
    word_t size = lai_exec_buffer_size(source);
...
static void lai_clone_string(lai_variable_t *dest, lai_variable_t *source) {
    word_t n = lai_exec_string_length(source);
